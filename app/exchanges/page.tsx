            ...
            <main className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="text-center space-y-6 py-12">
                    ...
                    <TypographyLead className="max-w-2xl mx-auto">
                        Find trusted exchanges and platforms where you can buy,
                        sell, and trade Neptune tokens. All listed exchanges
                        have been verified for security and reliability.
                    </TypographyLead>
                </div>
