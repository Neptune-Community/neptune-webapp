      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card>
          ...
          <CardContent>
            ...
            <TypographySmall>+20.1% from last month</TypographySmall>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <TypographySmall>All systems operational</TypographySmall>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 space-y-1">
                <TypographySmall>System updated</TypographySmall>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 space-y-1">
                <TypographySmall>New user registered</TypographySmall>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 space-y-1">
                <TypographySmall>Maintenance scheduled</TypographySmall>
