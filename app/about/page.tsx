      ...
      <main className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="text-center space-y-6 py-12">
          ...
          <TypographyLead className="max-w-3xl mx-auto">
            We are a passionate community of developers, researchers, and
            enthusiasts dedicated to expanding the Neptune ecosystem, adding
            real utility, and spreading awareness about the future of
            privacy-focused, quantum-secure cryptocurrency.
          </TypographyLead>
        </div>
          ...
          <Card className="bg-primary/2 border-l-4 border-l-primary">
            <CardContent className="pt-6">
              <TypographyP className="text-lg leading-relaxed">
                ...
                <strong>spread the word</strong> about the revolutionary
                potential of quantum-secure, privacy-focused cryptocurrency. We
                believe that financial privacy is a fundamental human right, and
                we're building the tools and infrastructure to make that vision
                a reality.
              </TypographyP>
            </CardContent>
          </Card>
        ...
        <section className="space-y-6">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {communityValues.map((value) => {
              ...
              return (
                <Card key={value.title} className="bg-primary/2">
                  <CardHeader>
                    <div className="flex items-center space-x-2">
                      <IconComponent className="h-5 w-5 text-primary" />
        ...
        <section className="space-y-6">
          ...
          <Card className="bg-primary/2">
            <CardContent className="pt-6 space-y-4">
              <TypographyP>
                Neptune Cash represents the next evolution of cryptocurrency.
                While other blockchains are vulnerable to quantum attacks and
                lack true privacy, Neptune is built from the ground up with:
              </TypographyP>
              <ul className="space-y-2 ml-4">
                <li className="flex items-start space-x-2">
                  <span className="text-primary mt-1">•</span>
                  <span>
                    <strong>Post-quantum cryptography</strong> - Future-proof
                ...
                <li className="flex items-start space-x-2">
                  <span className="text-primary mt-1">•</span>
                  <span>
                    <strong>zk-STARKs on Layer-1</strong> - Revolutionary
                    privacy technology
                  </span>
                </li>
                <li className="flex items-start space-x-2">
                  <span className="text-primary mt-1">•</span>
                  <span>
                    <strong>Mutator sets</strong> - Novel privacy solution
                ...
                <li className="flex items-start space-x-2">
                  <span className="text-primary mt-1">•</span>
                  <span>
                    <strong>Proof-of-Work consensus</strong> - Security rooted
                    in objective reality
                  </span>
                </li>
              </ul>
              <TypographyP>
                The Neptune Community recognizes that this technology represents
                the future of money, and we're committed to building the
                ecosystem that will make it accessible to everyone.
              </TypographyP>
            </CardContent>
          </Card>
        </section>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-3">
                  <TypographyP className="text-lg">
                    Whether you're a developer, researcher, investor, or simply
                    someone who believes in financial privacy, there's a place
                    for you in the Neptune Community.
                  </TypographyP>
                  <TypographyP>
                    Together, we're not just building software – we're building
                    the foundation for a more private, secure, and free
                    financial future. Join us in making this vision a reality.
                  </TypographyP>
                </div>
              </div>
            </CardContent>
        ...
        <section className="text-center space-y-4">
          ...
          <TypographyP className="text-muted-foreground">
            Explore our roadmap, contribute to our projects, or simply spread
            the word about the importance of quantum-secure, privacy-focused
            cryptocurrency.
          </TypographyP>
        </section>
      </main>
