            ...
            <div className="container mx-auto px-4">
                <main className="max-w-4xl mx-auto space-y-8">
                    ...
                    <div className="text-center space-y-4">
                        ...
                        <TypographyLead>
                            Track the development progress of community-driven
                            projects expanding the Neptune ecosystem
                        </TypographyLead>
                    </div>
                    ...
                    <section className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Join the Neptune community and help shape
                                    the future of quantum-secure cryptocurrency
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <TypographyP className="mb-4">
                                    The Neptune Community thrives on
                                    collaboration and innovation. Whether you're
                                    a developer, researcher, or enthusiast,
