  ...
  return (
    <div className="text-center space-y-6 py-12">
      ...
      <TypographyLead className="max-w-2xl mx-auto">
        ...
        peer-to-peer anonymous cash protocol featuring privacy, scalability, and
        post-quantum security. The first blockchain to integrate zk-STARKs on
        Layer-1 with revolutionary mutator sets.
      </TypographyLead>
