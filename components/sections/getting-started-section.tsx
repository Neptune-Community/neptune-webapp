...
export function GettingStartedSection() {
    return (
        <section className="space-y-6">
            ...
            <TypographyP>
                Neptune Core is an anonymous peer-to-peer cryptocurrency built
                in Rust. Follow the installation instructions below to get
                started with the Neptune network.
            </TypographyP>
            ...
            <Tabs defaultValue="cli" className="w-full">
                ...
                <TabsContent value="cli" className="space-y-4">
                    <Alert className="bg-primary/2">
                        <AlertDescription>
                            <strong>Windows Users:</strong> Follow the Windows
                            installation instructions for Rust and Cargo.
                            Installing cargo might require Visual Studio with
                            C++ support, but the cargo installer should handle
                            that.
                        </AlertDescription>
                    </Alert>

                    <TypographyP>
                        <strong>Installation:</strong> Install Rust and Cargo,
                        then build Neptune Core.
                    </TypographyP>
                    <TypographyOrderedList>
                        <TypographyListItem>
                            <strong>Install Rust and Cargo:</strong> Download
                            and install Rust from{" "}
                            <TypographyInlineCode>
                                rustup.rs
                            </TypographyInlineCode>
                            , which includes Cargo (Rust's package manager)
                        </TypographyListItem>
                        <TypographyListItem>
                            <strong>Clone the Repository:</strong>{" "}
                            <TypographyInlineCode>
                                git clone
                                https://github.com/Neptune-Crypto/neptune-core.git
                            </TypographyInlineCode>
                        </TypographyListItem>
                        <TypographyListItem>
                    ...
                    <TypographyP>
                        <strong>Running & Connecting:</strong> Once installed,
                        follow these steps to start using Neptune Core.
                    </TypographyP>
                    <TypographyOrderedList>
                        <TypographyListItem>
                        ...
                        <TypographyListItem>
                            ...
                            to interact with your wallet and monitor the network
                        </TypographyListItem>
                        <TypographyListItem>
                    ...
                    <TypographyP>
                        <strong>Important:</strong> Any commit except the one
                        tagged{" "}
                        <TypographyInlineCode>release</TypographyInlineCode> is
                        considered an <em>unstable development</em> commit and
                        carries a higher risk of database corruption and/or loss
                        of funds.
                    </TypographyP>
                </TabsContent>
                ...
                <TabsContent value="wallets" className="space-y-4">
                    <TypographyP>
                        <strong>Desktop Wallet:</strong> Neptune's inaugural
                        wallet program provides a user-friendly interface for
                        managing your Neptune assets.
                    </TypographyP>
                    ...
                    <div className="space-y-4">
                        <div className="p-4 border rounded-lg">
                            ...
                            <TypographyP className="text-sm text-muted-foreground mb-3">
                                Neptune's inaugural desktop wallet application,
                                committed to providing users with a secure and
                                convenient digital asset management experience.
                            </TypographyP>
